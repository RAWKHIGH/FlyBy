...
public class MainMenu extends BaseGameActivity  implements IOnMenuItemClickListener {
	...
	public boolean onMenuItemClicked(final MenuScene pMenuScene, final IMenuItem pMenuItem, final float pMenuItemLocalX, final float pMenuItemLocalY) {
		switch(pMenuItem.getID()) {
			...
			case MENU_SCORES:
				//removed
				Toast.makeText(MainMenu.this, "SCORES selected", Toast.LENGTH_SHORT).show();
				return true;
			case MENU_OPTIONS:
				//removed
				Toast.makeText(MainMenu.this, "MENU OPTIONS selected", Toast.LENGTH_SHORT).show();
				return true;
			case MENU_HELP:
    ...
    private Runnable mLaunchLevel1Task = new Runnable() {
        public void run() {
    		Intent myIntent = new Intent(MainMenu.this, GameLevel.class);
